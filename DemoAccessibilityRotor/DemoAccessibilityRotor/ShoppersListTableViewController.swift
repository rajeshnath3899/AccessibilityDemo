...
class ShoppersListTableViewController: UITableViewController {
    ...
    func setUpStoreModel() {
        ...
        let store2 = Store(storeName: "Sangeetha Electronics", storeAddress: "Jayanager 4rd block", hasSpecialOffers: true)
        let store3 = Store(storeName: "Vikas Electronics", storeAddress: "Rajajinager 1st cross", hasSpecialOffers: true)
        let store4 = Store(storeName: "Gireesh Electronics", storeAddress: "Rajajinager 7th cross", hasSpecialOffers: true)
        let store5 = Store(storeName: "Vivo Electronics", storeAddress: "Rajajinager 4th cross", hasSpecialOffers: false)
